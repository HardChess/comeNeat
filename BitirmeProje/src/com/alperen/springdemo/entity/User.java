...
public class User {
	...
	@Column(name="name")
	@Size(min=1, max=20, message="1-20 aras� karakter girin.")
	...
	@Column(name="address")
	@Size(min=1, max=100, message="1-100 aras� karakter girin.")
	@NotNull(message="bos olamaz.")
	private String address;
	
	@Column(name="username")
	@Size(min=1, max=45, message="1-45 aras� karakter girin.")
	@NotNull(message="bos olamaz.")
